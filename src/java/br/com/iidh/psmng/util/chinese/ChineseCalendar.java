...
/**
 * ChineseCalendar.java Copyright (c) 1997-2019 HerongYang.com, All Rights
 * Reserved. Valid for 200 years: from Gregorian year 1901 to 2100 Not
 * sychronized.
 */
class ChineseCalendar {
    ...
    private GregorianCalendar gcAnoNovoChinesCalendarioOcidental;
    ...
    public static void main(String[] arg) {
        String[] param = arg;
        int tipoConsulta = 0; // 0 = day, 1 = month, 2 = year
        if(arg.length <= 0){
            switch(tipoConsulta){
                case 0:
                    param = new String[4];
    ...
    public ChineseCalendar(int ano, int mes, int dia) {
        setGregorian(ano, mes, dia);
        String[] t = this.getYearTable();
        setGregorian(ano, mes, dia);
    ...
    public String getDateString() {
        ...
        //Ano novo
        if (chineseDate == 1 && chineseMonth ==1){
            gcAnoNovoChinesCalendarioOcidental = new GregorianCalendar(gregorianYear, gregorianMonth - 1, Integer.parseInt(gd.trim()));
        }   
    ...
    public GregorianCalendar getGcAnoNovoChinesCalendarioOcidental() {
        return gcAnoNovoChinesCalendarioOcidental;
    }
