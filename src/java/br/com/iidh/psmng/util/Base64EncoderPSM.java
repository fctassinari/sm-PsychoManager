 ...
 *
 *
 * This class is a modified version based on code obtained from the w3
 * consortium website, which is subject to their generic copyright notice:
 *
 * <dl>
 ...
 * en Automatique</a>, <a HREF="http://www.keio.ac.jp/">Keio University</a>).
 * All Rights Reserved. This program is distributed under the <a
 ...
 * W3C License <a
 * href="http://www.w3.org/Consortium/Legal/">http://www.w3.org/Consortium/Legal/</a>
 * for more details. </dd>
 * </dl>
 *
 *
 */
public final class Base64EncoderPSM {
     ...
     */
    public static String criptografarSenhaWildFly(String senha, String hashAlgorithm) throws Exception {
        byte[] hash = java.security.MessageDigest.getInstance(hashAlgorithm).digest(senha.getBytes());
//        System.out.println("[" + Base64Encoder.encode(hash) + "]");
        return Base64EncoderPSM.encode(hash);
    }
     ...
     * @throws java.lang.Exception
     */
    public static String criptografarSenhaGlassFish(String senha, String hashAlgorithm) throws Exception {
    ...
    public static void main(String args[]) throws Exception {
        if (args.length == 1) {
            System.out.println("[" + Base64EncoderPSM.encode(args[0]) + "]");
            // joe:eoj -> am9lOmVvag==
            ...
            System.out.println("[" + Base64EncoderPSM.encode(hash) + "]");
        } else {
